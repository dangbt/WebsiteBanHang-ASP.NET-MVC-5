...
namespace WebsiteBanHang.Controllers
{
    ...
    public class QuanLyDonHangController : Controller
    {
        ...
        public ActionResult ChuaGiao()
        {
            ...
            var lstDSDHCG = db.DonDatHangs.Where(n => n.TinhTrangGiao == false && n.DaThanhToan == true).OrderBy(n => n.NgayGiao);
            return View(lstDSDHCG);
        }
        public ActionResult DaGiaoDaThanhToan()
        {
            //Lấy danh sách đơn hàng chưa giao 
            var lstDSDHCG = db.DonDatHangs.Where(n => n.TinhTrangGiao == true && n.DaThanhToan == true);
            return View(lstDSDHCG);
        }
        [HttpGet]
        ...
        public ActionResult DuyetDonHang(DonDatHang ddh)
        {
            ...
            GuiEmail("Xác đơn hàng của hệ thống myclass.vn", "buitandang96@gmail.com", "14110017@student.hcmute.edu.vn", "tinhanhdo", "Đơn hàng của bạn đã được đặt thành công!");
